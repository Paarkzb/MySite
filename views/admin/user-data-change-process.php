...
echo "
<a href='index.php?r=admin/user-data&id=$personalData->user_id&o_id=$o_id&status=$status' class='btn btn-success'>Вернуться</a>
<h1 class='text-center'>Изменение данных участника № $personalData->personal_data_id</h1>
<hr>
";

$form = ActiveForm::begin(['action' => 'index.php?r=admin/user-data-change-process']);
